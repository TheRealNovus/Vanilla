...
public class HumanEntityProtocol extends VanillaEntityProtocol {
	...
	public List<Message> getSpawnMessages(Entity entity, RepositionManager rm) {
		...
		int id = entity.getId();
		int x = VanillaChannelBufferUtils.protocolifyPosition(rm.convertX(entity.getScene().getPosition().getX()));
		int y = VanillaChannelBufferUtils.protocolifyPosition(rm.convertY(entity.getScene().getPosition().getY()));
		int z = VanillaChannelBufferUtils.protocolifyPosition(rm.convertZ(entity.getScene().getPosition().getZ()));
		int r = VanillaChannelBufferUtils.protocolifyYaw(entity.getScene().getRotation().getYaw());
		int p = VanillaChannelBufferUtils.protocolifyPitch(entity.getScene().getRotation().getPitch());
